...
def resnet_model(name, resnet_name, use_bottleneck=True, bottleneck_dim=256, new_cls=True, ema=False, class_num=1000):
    model = name(resnet_name, use_bottleneck, bottleneck_dim, new_cls, ema, class_num)
    if ema:
