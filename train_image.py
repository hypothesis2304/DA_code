...
def train(config):
    ...
    for i in trange(config["num_iterations"], leave=False):
        ...
        if config['method'] == 'DANN+E':
            ...
            ent_loss = Categorical(probs=outputs_target).entropy()
            # print(ent_loss)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default='DANN+E', choices=['DANN+E', 'DANN'])
    ...
    parser.add_argument('--snapshot_interval', type=int, default=5000000, help="interval of two continuous output model")
    ...
    config["loss"]["random_dim"] = 256#1024
